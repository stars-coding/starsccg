...
public class CosManager {
    ...
    public void deleteObject(String key) throws CosClientException, CosServiceException {
        this.cosClient.deleteObject(this.cosClientConfig.getBucket(), key);
    }
    ...
    public DeleteObjectsResult deleteObjects(List<String> keyList)
        ...
        DeleteObjectsRequest deleteObjectsRequest = new DeleteObjectsRequest(this.cosClientConfig.getBucket());
    ...
    public void deleteDir(String delPrefix) throws CosClientException, CosServiceException {
        ...
        // 设置 bucket 名称
        listObjectsRequest.setBucketName(this.cosClientConfig.getBucket());
        ...
        do {
            objectListing = this.cosClient.listObjects(listObjectsRequest);
